...
!         1         2         3         4         5         6         7         8         9         0
  ...
  DATA PROG_REV /'$Rev:: 189  $ ($Date:: 2011-08-09 08:55:36 +0100 (Tue, 09 Aug 2011) $)'/
  ...
  mwpointer:: intensity_pr, error_int_pr
  ...
  call slice_df(%val(vx_pr),%val(vy_pr),%val(vz_pr), &
       %val(pixel_int_pr),%val(pixel_err_pr), ndet*ne, & 
       vx_min-bin_vx/2.0d0,bin_vx,n, &
       vy_min-bin_vy/2.0d0,bin_vy,m,vz_min,vz_max, &
       %val(intensity_pr),%val(error_int_pr))
