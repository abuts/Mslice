...
!                    123456789012345678901234567890123456789012345678901234567890123456789010123
!                    1         2         3         4         5         6         7         8   
      mwpointer :: plhs(*), prhs(*)
...
!    Get x values, perm and number_pix information
      ...
      if(x_pr*perm_pr*number_pix_pr==0)then
            call mexErrMsgTxt('Can not allocate properly one of the output parameters')      
      end if 
...
!     Call averaging subroutine avpix_df
      call avpix_df(%val(x_pr),Ntotal,%val(perm_pr),Npixels,%val(number_pix_pr),Nbins,%val(xx_pr),%val(std_dev_pr))
