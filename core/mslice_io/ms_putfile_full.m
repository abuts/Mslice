function file_out = ms_putfile_full (filterspec,dialogtitle)
% Utility to get file name for output:  file_out = ms_putfile_full (filterspec,dialogtitle)
%
...
%  - It sensibly decide whether or not to open a dialogue box: 
%       if just the name of a file that actually exists was passed (i.e. no dialogue box argument), then file_out = filterspec,
