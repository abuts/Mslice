function varargout=ms_global_var(varargin)
% store and retrieve variables which are hidden from the
% matlab workspace. 
%
% syntax: 
% 
% >> output=ms_global_var('variable_set', 'set / get / clear','variable',variable_value) 
% >> ms_global_var('variable_set','copy','new_set1', 'new_set2', ...)
%
% usage:
%
% >> output = ixf_gloabl_var('variable_set','get','var1','var2','var3',...)
% >> ms_global_var('variable_set','set','variable',value)
% >> ms_global_var('variable_set','remove')
% >> ms_global_var('variable_set','clear')
% >> ms_global_var('variable_set','copy','new_set', ....)
%
%---------
% inputs:   
%---------
...
%
% >> ms_global_var('graphics','clear','IXG_ST_VARS')
%
% AND
%
% >> ms_global_var('libisis_graphics','set','IXG_ST_VARS')
%
% Are the same.
%
...
%
% ms_global_var('variable_set', 'get') displays a list of current stored variables
%       for the given property set
% ms_global_var() displays a list of property_sets
% ms_global_var'variable_set') displays a list of stored values also
%
%----------
% examples:
%----------
