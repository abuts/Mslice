...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer,pointer:: vx_pr, vy_pr, vz_pr, pixel_int_pr, pixel_err_pr, grid_pr,temp_pr
  integer,pointer:: x_pr, intensity_pr, error_int_pr
...
subroutine cut3dxye_df(vx,vy,vz,pixel_int,pixel_err,ndet,ne,Npixels,vx_min,vx_max,bin_vx,eps,n,&
  ...
  integer m, n, ndet, ne, Npixels, bin_index(n), final_npixel,number_pix(n)
