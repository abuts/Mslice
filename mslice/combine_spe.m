function combine_spe(weight,spedir,spefiles,spefileout)
% Add together spe files with arbitrary weight
%
%   >> combine_spe(weight,spedir,spefiles,spefileout)
%
%   weight      Multiplicative factors for the spe files. Weights can be negative.
...
%
% Does not normalise data by weights; can be used to take differences, for example:
%
%   >> combine_spe ([1,-1],'c:\temp\',{'High_Temp.spe','Low_Temp.spe'},'difference.spe')
%
%
% The algorithm is:
