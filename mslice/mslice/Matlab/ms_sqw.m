...
% Cross-section model for simulation of scattering. 
%
%	>> [s,wdisp]=ms_sqw(icross,par,Q,w,theta,ar,br,cr)
%
%   par             Vector of parameters for cross-section calculation
%   Q               Q points (h,k,l) (size(Q)=(n,3))
%   w               w values at Q (size(w)=n)
%   theta           total scattering angle for each pixel (rad)
%   ar,br,cr        Reciprocal lattice vectors (Ang^-1) in the orthonormal basis 
%                  defined by u and v (x-axis along u, z-axis along u x v)
%
%   s               signal array calculated at all n points
%   wdisp           dispersion relation at the n Q values
%

% *** ISIS changes
% T.G.Perring:  Help updated 
