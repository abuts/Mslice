...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  real*8 grid(7), vx_min, vx_max, bin_vx, vy_min, vy_max, vz_min, vz_max, vvy, vvz, eps
  interface
     function mxgetpr(pm)
  ...
  call cut3dxye_df(vx_pr,vy_pr,vz_pr,pixel_int_pr,pixel_err_pr, ndet, ne, ndet*ne, vx_min,vx_max,&
       bin_vx,eps,n,vy_min,vy_max,vz_min,vz_max,x_pr,intensity_pr,error_int_pr,m,vvy,vvz)
...
! =============================================================================== 
subroutine cut3dxye_df(vx,vy,vz,pixel_int,pixel_err,ndet,ne,Npixels,vx_min,vx_max,bin_vx,eps,n,vy_min,vy_max,vz_min,vz_max, x,intensity,error_int,m,vvy,vvz)
  ...
  real*8 vx(*), vy(*), vz(*), pixel_int(*), pixel_err(*), vx_min, vx_max, bin_vx, eps, vy_min, vy_max, vz_min, vz_max,x(*), intensity(*),error_int(*), vvy, vvz
