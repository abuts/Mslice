...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer*4,pointer:: vx_pr, vy_pr, vz_pr, pixel_int_pr, pixel_err_pr, grid_pr
  integer*4,pointer:: intensity_pr, error_int_pr
...
subroutine slice_df(vx,vy,vz, &
  ...
  !     m = number of rows, 
  !     n = number of columns	
  integer*4 m, n, number_pts(m*n), Npixels
