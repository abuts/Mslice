...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer*4,pointer:: emode_pr, efixed_pr, en_pr, det_theta_pr, det_psi_pr,psi_samp_pr
  integer*4,pointer:: U1_pr, U2_pr, U3_pr,v1_pr, v2_pr, v3_pr 
  ! declare calling functions
  integer*4 mxCreateFull, mxGetM, mxGetN, mxIsNumeric
