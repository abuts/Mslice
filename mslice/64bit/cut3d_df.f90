...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  plhs(1)	    =mxCreatedoublematrix(1_i8b,n,0) ! these are matlab pointsrs
  ...
  plhs(7)       =mxCreatedoublematrix(1_i8b,1_i8b,0)
  ...
  call mxCopyReal8ToPtr(vvz,mxGetPr(plhs(7)),1_i8b)
  return
