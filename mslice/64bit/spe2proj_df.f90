...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer*8,pointer:: emode_pr, efixed_pr, en_pr, det_theta_pr, det_psi_pr,psi_samp_pr
  integer*8,pointer:: U1_pr, U2_pr, U3_pr,v1_pr, v2_pr, v3_pr 
...
! this one is somehow still required
        call mxCopyPtrToReal8(emode_pr,emode,1_i8b)
  ...
  call spe2proj_df(emode,efixed_pr,en_pr,ne,det_theta_pr,det_psi_pr,ndet,psi_samp_pr,U1_pr,&
       U2_pr,U3_pr,v1_pr,v2_pr,v3_pr)
  return
