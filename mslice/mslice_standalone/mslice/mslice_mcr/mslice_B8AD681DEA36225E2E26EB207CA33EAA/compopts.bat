...
rem    with Microsoft Visual C++ compiler version 7.0 
rem
rem    $Revision: 1.1.8.9 $  $Date: 2007/06/07 14:12:50 $rem    
rem
rem ********************************************************************
...
set INCLUDE=%VCINSTALLDIR%\INCLUDE;%VCINSTALLDIR%\SDK\v1.1\Include;%VCINSTALLDIR%\PlatformSDK\Include;%INCLUDE%
set LIB=%VCINSTALLDIR%\PlatformSDK\lib;%VCINSTALLDIR%\LIB;%MATLAB%\extern\lib\win32;%LIB%
