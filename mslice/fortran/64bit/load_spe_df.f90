...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer*8,pointer:: data_S_pr, data_ERR_pr, data_en_pr
  ! declare external calling functions
  integer*8  mxGetString,mxCreateFull, mxGetM, mxIsString,  mxGetN !, mxGetPr

  ! declare local operating variables of the interface funnction
  integer*8 ndet, ne, strlen, status
  ...
  plhs(3)=mxCreateFull(1_i8b,ne,0)      
