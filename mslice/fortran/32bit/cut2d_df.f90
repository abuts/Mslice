...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer,pointer:: vx_pr, vy_pr, pixel_int_pr 
  integer,pointer:: pixel_err_pr, grid_pr,  temp1, temp2, temp3
...
subroutine cut2d_df(vx,vy,pixel_int,pixel_err,ndet,ne,Npixels,vx_min,vx_max,bin_vx,&
  ...
  integer m, n, ndet, ne, Npixels, pixel_index1(*), pixel_index2(*), pixel_index3(*)
  integer bin_index(n), cumm_npixels(n), final_npixel
