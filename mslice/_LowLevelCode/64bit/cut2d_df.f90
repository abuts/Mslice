...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
  ...
  integer*8,pointer:: x_pr, intensity_pr, error_int_pr, perm_pr, number_pix_pr,temp_pr
  ...
  call mxCopyPtrToReal8(grid_pr,grid,5_i8b)
  vx_min=grid(1)
  vx_max=grid(2)
  bin_vx=grid(3)
  vy_min=grid(4)
  ...
  plhs(1)	    =mxCreatedoublematrix(1_i8b,n,0)
  plhs(2)	    =mxCreatedoublematrix(1_i8b,n,0)
  plhs(3)       =mxCreatedoublematrix(1_i8b,n,0)
  plhs(4)       =mxCreatedoublematrix(ndet*ne,1_i8b,0)
  plhs(5)       =mxCreatedoublematrix(1_i8b,n,0)
  x_pr          =>mxGetPr(plhs(1))
  ...
  temp1=>mxCalloc(ndet*ne,4_i8b) ! integer*8
  temp2=>mxCalloc(ndet*ne,4_i8b) ! integer*8
  temp3=>mxCalloc(ndet*ne,4_i8b) ! integer*8
  ...
  call cut2d_df(vx_pr,vy_pr,pixel_int_pr,pixel_err_pr, ndet, ne, ndet*ne,&
       ...
       m,perm_pr,number_pix_pr,final_npixel,vvy(1),temp1,temp2,temp3)
  ...
  temp=mxCreatedoublematrix(final_npixel,1_i8b,0)
  ...
  plhs(6)       =mxCreatedoublematrix(1_i8b,1_i8b,0)
  call mxCopyReal8ToPtr(vvy,mxGetPr(plhs(6)),1_i8b)
  return
...
subroutine cut2d_df(vx,vy,pixel_int,pixel_err,ndet,ne,Npixels,vx_min,vx_max,bin_vx,&
  ...
  integer*8 m, n, ndet, ne, Npixels, pixel_index1(*), pixel_index2(*), pixel_index3(*)
  integer*8 bin_index(n), cumm_npixels(n), final_npixel
