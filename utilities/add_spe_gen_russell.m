function add_spe_gen_russell(weight,spedir,spefiles,spefileout)
...
% R.A. Ewings 26-Nov-2009. Error to catch different energy bins is over-ridden. Numeric
% precision problems were preventing adding 2 identical spe files...
