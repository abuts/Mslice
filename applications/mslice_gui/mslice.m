...
h=uicontrol('Parent',fig,'Style','text','String','geometry',...
   'Position',pos+[4*pos(3) 3/2*interlines 0 0]);   
...
h=uicontrol('Parent',fig,'Style','edit','Enable','on','Tag','ms_DataFile',...
   ...
   'HorizontalAlignment','left',...
	'BackgroundColor',white);
%-- nxspe checkbox;
h=uicontrol('Parent',fig,'Style','checkbox','String','phx from nxspe',...
                 'Callback','ms_selectPhxFromNxSpe',...
                 'Tag','ms_usePhxFromNXSPE',...
                 'Position',pos+[5*pos(3) interlines 80 0]);
...
h1=uimenu(h,'Label','W1','Callback','ms_store_data(''W1'');');
h1=uimenu(h,'Label','W2','Callback','ms_store_data(''W2'');');
h1=uimenu(h,'Label','W3','Callback','ms_store_data(''W3'');');
h1=uimenu(h,'Label','W4','Callback','ms_store_data(''W4'');');
h1=uimenu(h,'Label','W5','Callback','ms_store_data(''W5'');');
h1=uimenu(h,'Label','W6','Callback','ms_store_data(''W6'');');
h1=uimenu(h,'Label','RESET','Callback','ms_store_data(''RESET'');');
