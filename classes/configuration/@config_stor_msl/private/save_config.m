...
% Input:
% ------
%   file_name          Full name of file to hold configuration structure
%   config_data_class  Class holding the structure with configuration
%
% Output:
% -------
%   Throws error  HERBERT:config_stor_msl:io_error if problem with saving
%
...
if is_file(file_name)
    try
        ...
        ERR = MException('HERBERT:config_stor_msl:io_error', ...
