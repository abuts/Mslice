...
% Function stores the configuration class - child of a config_bas_msl class
...
elseif(is_string(config_class))
    ...
    error('HERBERT:config_stor_msl:invalid_argument',...
        'input for config_stor_msl should be either instance of config class or string with a config class name')
end
