...
% function looks through the Mslice msp configuration file and tries to replace
% pairs of keys it founds by its values
%
% parameters:
% config_file -- full path to a msp file
% keys        -- cell-array of strings treated as keys
% values      -- cell-array of strings treated as values
% 
% returns
% success -- 1 if success or 0 if failure. 
