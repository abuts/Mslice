...
if narg==1
    ...
    elseif isa(svar,'config_bas_msl')
        S = svar.get_data_to_store();
        return;
    else
        ok=false; mess='Second parameter of two has to be a structure, a cell array, config_bas_msl class or the option ''defaults'''; return
    end
