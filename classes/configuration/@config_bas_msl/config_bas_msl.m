classdef config_bas_msl
    ...
    methods
        function obj=config_bas_msl(class_name)
            ...
            if ischar(class_name)
                ...
                error('HERBERT:config_bas_msl:constructor', ...
                    'first config_bas_msl variable has to be a string, providing the derived class name');
            end
        end
    ...
    methods
        ...
        function isit = is_field_configured(obj,field_name)
            isit = config_stor_msl.instance().is_field_configured(obj,field_name);
        end
        %------------------------------------------------------------------
        function value =get_or_restore_field(obj,field_name)
            ...
            if obj.returns_defaults
                ...
                value = config_stor_msl.instance.get_config_field( ...
                    obj,field_name);
            end
        end
