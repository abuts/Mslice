...
%
%>>[det,ldr_msl_nxspe]= ldr_msl_nxspe.load_par(['-nohor'])
%                      returns detectors information loaded from the nxspe file,
%                      previously associated with ldr_msl_nxspe class by
%                      ldr_msl_nxspe constructor
%
...
%  ldr_msl_nxspe_var -- the instance of properly initiated ldr_msl_nxspe class
...
%     6th  "        detector ID
%
%>>[det,ldr_msl_nxspe]=ldr_msl_nxspe.load_par(file_name,['-array'])
...
%                     sets ldr_msl_nxspe read detectors from ascii par file if
%                     this file name refers to ascii par file
%
%
% $Revision: 385 $ ($Date: 2014-09-08 16:10:21 +0100 (Mon, 08 Sep 2014) $)
%
...
if isempty(this.par_file_name)
    ...
    [det,this]=load_par@asciipar_msl_ldr(this,params{:});
end
%--------------------------------------------------------------------------
function [return_array,reload,file_provided,new_file_name,lext]=parse_par_file_arg(this,options,varargin)
% method analyses and processes various options specified with ldr_msl_nxspe.load_par
% command
%
%
new_file_name ='';
