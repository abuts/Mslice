classdef ldr_msl_nxspe < a_msl_loader
    ...
    methods(Static)
        ...
        function [ok,fh] = can_load(file_name)
            ...
            [ndet,en,full_file_name,ei,psil,nexus_dir,nxspe_ver]=ldr_msl_nxspe.get_data_info(file_name);
    ...
    methods
        ...
        function this = ldr_msl_nxspe(full_nxspe_file_name,varargin)
    ...
    methods(Static)
        function ndet=get_par_info(par_file_name,file_name)
            ...
            if ~isempty(par_file_name)
                ndet = a_msl_loader.get_par_info(par_file_name);
            else
                ndet =  ldr_msl_nxspe.get_data_info(file_name);
            end
        end
    end
