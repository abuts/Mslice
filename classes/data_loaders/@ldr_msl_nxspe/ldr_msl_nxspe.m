classdef ldr_msl_nxspe < a_msl_loader
    ...
    methods(Static)
        ...
        function descr=get_file_description()
            ...
            % loader.
            ext = ldr_msl_nxspe.get_file_extension();
        ...
        function [ok,fh] = can_load(file_name)
            ...
            % Output:
            %
            % ok   -- True if the file can be processed by the ldr_msl_nxspe
            ...
            [ndet,en,full_file_name,ei,psil,nexus_dir,nxspe_ver,dataset_info]=ldr_msl_nxspe.get_data_info(file_name);
        ...
        function [ndet,en,file_name,ei,psi,nexus_dir,nxspe_ver,nexus_datast_info]=get_data_info(file_name)
            ...
            %
            % >> [ndet,en,full_file_name,ei,psi,nexus_ver,nexus_dir] = ldr_msl_nxspe.get_data_info(filename)
            %
            % where:
    ...
    methods
        ...
        %
        function obj = ldr_msl_nxspe(full_nxspe_file_name,varargin)
            ...
            %
            %usage:
            %>>loader=ldr_msl_nxspe(full_nxspe_file_name)
            %where:
            % full_nxspe_file_name -- full file name (with path) to proper
            %                         nxspe file
            
            obj=obj@a_msl_loader(varargin{:});
        ...
        function fields = defined_fields(this)
            ...
            %
            fields = defined_fields@a_msl_loader(this);
        ...
        function obj = set_data_info(obj,nxspe_file_name)
            ...
            [obj.n_detindata_,obj.en_,obj.data_file_name_,...
                ...
                ldr_msl_nxspe.get_data_info(nxspe_file_name);
        end
        %
        ...
        function obj = set_data_file_name(obj,filename)
            ...
            if ~isempty(obj.detpar_loader_)
                if strcmp(filename,obj.par_file_name)
                    ...
                    obj = set_data_file_name@a_msl_loader(obj,filename);
                end
            else
                obj = set_data_file_name@a_msl_loader(obj,filename);
            end
