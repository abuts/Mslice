classdef ldr_msl_speh5 < a_msl_loader
    ...
    %
    % $Revision: 374 $ ($Date: 2014-04-05 21:44:50 +0100 (Sat, 05 Apr 2014) $)
    %
    ...
    methods(Static)
        ...
        function descr=get_file_description()
            ...
            % loader.
            ext = ldr_msl_speh5.get_file_extension();
        ...
        function [ok,fh] = can_load(file_name)
            ...
            [ndet,en,full_file_name,ei,spe_h5ver]=ldr_msl_speh5.get_data_info(file_name);
        ...
        function [ndet,en,full_file_name,ei,spe_h5Ver]=get_data_info(file_name)
            ...
            % format by Libisis
            %
            % >> [ndet,en,full_file_name,ei,spe_h5Ver] = ldr_msl_speh5.get_data_info(filename)
            %
            % where:
    ...
    methods
        function this = init(this,speh5_file_name,par_file_name,fh)
            % method initate internal structure of ldr_msl_speh5, which is responsible for
        ...
        function this = ldr_msl_speh5(full_speh5_file_name,varargin)
        ...
        function this = set_data_info(this,full_speh5_file_name)
            ...
            [this.n_detindata_stor,this.en_stor,this.data_file_name_stor, ...
                this.efix,this.speh5_version]=ldr_msl_speh5.get_data_info(full_speh5_file_name);
        end
