...
% function loads ldr_msl_membased data into run_data structure
%
% this function is the method of ldr_msl_membased class
%
...
tmf = mem_msl_fs.instance().load_file(filename);
data{1}  = tmf.S;
data{2}  = tmf.ERR;
if isempty(this.en)
    this.en_ =tmf.en;
