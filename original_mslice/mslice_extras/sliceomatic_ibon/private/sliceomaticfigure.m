...
fig=findobj('Tag','sliceomatic');
if isempty(fig),
   colordef none;
   fig=figure('MenuBar','none','Resize','on',...
              'Name','MSlice : Sliceomatic',... 
              'NumberTitle','off',...
              'Tag','sliceomatic','PaperPositionMode','auto');
 else
         %figure(fig); 
         clf(fig,'reset')
    ...
    %modified by i.bustinduy on 3rd Nov 2005
    
  uicontrol('style','edit','string','0','BackgroundColor','white',...
...
%Modified by sri
 d.axmain = axes('units','normal','pos',[.1  .1 .8 .8],'box','on',...
  ...
  %modified by I.Bustinduy::
  % Color and alph maps
  uicontrol('style','text','string','ColorMap','BackgroundColor',[0.9,0.9,0.9],...
  ...
  uicontrol('style','text','string','AlphaMap','BackgroundColor',[0.9,0.9,0.9],...
