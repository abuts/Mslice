...
if (samp==1)&(analmode==1),	% single crystal sample in single crystal analysis mode, axes are in wavevector-enery space 
    ...
    if (z==1),set(MA_x_axis,'String',axis_label(2,:)); set(MA_y_axis,'String',axis_label(3,:));  end
    if (z==2),set(MA_x_axis,'String',axis_label(3,:)); set(MA_y_axis,'String',axis_label(1,:));  end
    if (z==3),set(MA_x_axis,'String',axis_label(1,:)); set(MA_y_axis,'String',axis_label(2,:));  end
