===============================================================================
 Mslice installation                             (T.G.Perring 8 July 2007)
===============================================================================

This folder and sub-folders contain the mslice program of Radu Coldea (in
sub-folder \mprogs), together with some minor corrections and enhancements
(\mslice_corrections) and extra functions that extend the use of mslice
(\mslice_extras).
...
New unctions that add functionality to mslice. See the word document
